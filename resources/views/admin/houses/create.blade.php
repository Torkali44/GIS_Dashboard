    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-800/80 pb-6">
        <div>
            <div class="flex items-center gap-2 text-xs text-slate-400 mb-2">
                ...
                <span>/</span>
                <span class="text-emerald-400">عقد جديد</span>
            </div>
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-0.5">
                        سيتم توليد رقم العقد تلقائياً (مثال: GIS-{{ date('Y') }}-xxxx) ويمكن تعديله لاحقاً.
                    </p>
                </div>
            </div>
        </div>

        <a href="{{ route('admin.houses.index') }}" class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold text-slate-300 bg-slate-800/80 hover:bg-slate-700 border border-slate-700/60 transition-all">
            ← العودة لقائمة العقود
        </a>
    </div>

    {{-- Main Form --}}
    <form method="post" action="{{ route('admin.houses.store') }}" class="space-y-8">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                    <label for="contract_number" class="block text-xs font-semibold text-slate-300 mb-1.5 flex items-center justify-between">
                        <span>رقم العقد (اختياري)</span>
                        <span class="text-[10px] text-emerald-400 font-normal">يترك فارغاً للتوليد التلقائي</span>
                    </label>
                    <input id="contract_number" name="contract_number" type="text"
                           value="{{ old('contract_number') }}"
                           placeholder="مثال: GIS-{{ date('Y') }}-0001"
                ...
                <div>
                    ...
                    <input id="contract_date" name="contract_date" type="date"
                           value="{{ old('contract_date', date('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <select id="contract_status" name="contract_status"
                            class="w-full rounded-xl border border-slate-700/80 bg-slate-950/70 px-3.5 py-2.5 text-sm text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none transition-all">
                        <option value="draft" {{ old('contract_status') === 'draft' ? 'selected' : '' }}>مسودة</option>
                        <option value="active" {{ old('contract_status', 'active') === 'active' ? 'selected' : '' }}>ساري / نشط</option>
                        <option value="completed" {{ old('contract_status') === 'completed' ? 'selected' : '' }}>مكتمل ومسلّم</option>
                        <option value="cancelled" {{ old('contract_status') === 'cancelled' ? 'selected' : '' }}>ملغي</option>
                    </select>
                ...
                <div>
                    <label for="price" class="block text-xs font-semibold text-amber-300 mb-1.5 flex items-center justify-between">
                        ...
                        <span class="text-[10px] text-amber-400 font-normal">البند الرابع</span>
                    </label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <select id="payment_method" name="payment_method"
                        ...
                        <option value="benefit" {{ old('payment_method', 'benefit') === 'benefit' ? 'selected' : '' }}>Benefit / بنفت</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <input id="building_status" name="building_status" type="text"
                           value="{{ old('building_status', 'مشطب (غير مؤثث)') }}"
        ...
        <div class="bg-slate-900/90 rounded-2xl border border-slate-800/80 p-6 md:p-7 shadow-xl space-y-6 relative overflow-hidden">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input id="land_area" name="land_area" type="text" value="{{ old('land_area') }}"
                ...
                <div>
                    ...
                    <input id="building_area" name="building_area" type="text" value="{{ old('building_area') }}"
                ...
                <div>
                    ...
                    <input id="property_age" name="property_age" type="text" value="{{ old('property_age') }}"
                ...
                <div>
                    ...
                    <input id="floors_count" name="floors_count" type="text" value="{{ old('floors_count') }}"
                ...
                <div>
                    ...
                    <input id="rooms_count" name="rooms_count" type="text" value="{{ old('rooms_count') }}"
                ...
                <div>
                    ...
                    <input id="bathrooms_count" name="bathrooms_count" type="text" value="{{ old('bathrooms_count') }}"
                           placeholder="مثال: 5"
                           class="w-full rounded-xl border border-slate-700/80 bg-slate-950/70 px-3 py-2 text-sm text-white focus:border-amber-500 focus:outline-none transition-all">
                </div>
                ...
                <div>
                    ...
                    <input id="halls_count" name="halls_count" type="text" value="{{ old('halls_count') }}"
                ...
                <div>
                    ...
                    <input id="parking_count" name="parking_count" type="text" value="{{ old('parking_count') }}"
                ...
                <div>
                    ...
                    <input id="kitchens_count" name="kitchens_count" type="text" value="{{ old('kitchens_count') }}"
                ...
                <div>
                    ...
                    <input id="developer_name" name="developer_name" type="text" value="{{ old('developer_name') }}"
                           placeholder="مثال: ديار المحرق"
                           class="w-full rounded-xl border border-slate-700/80 bg-slate-950/70 px-3 py-2 text-sm text-white focus:border-amber-500 focus:outline-none transition-all">
                </div>
                ...
                <div>
                    ...
                    <input id="engineering_supervisor" name="engineering_supervisor" type="text" value="{{ old('engineering_supervisor') }}"
                ...
                <div>
                    ...
                    <input id="main_contractor" name="main_contractor" type="text" value="{{ old('main_contractor') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <textarea id="contract_notes" name="contract_notes" rows="4"
                              ...
                              class="w-full rounded-xl border border-slate-700/80 bg-slate-950/70 px-3.5 py-2.5 text-sm text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:outline-none transition-all leading-relaxed">{{ old('contract_notes') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="4"
                              ...
                              class="w-full rounded-xl border border-slate-700/80 bg-slate-950/70 px-3.5 py-2.5 text-sm text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:outline-none transition-all leading-relaxed">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-xs text-red-400">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="sticky bottom-4 z-20 bg-slate-900/95 backdrop-blur-md rounded-2xl border border-slate-700/70 p-4 shadow-2xl flex flex-wrap items-center justify-between gap-4">
            <div class="flex items-center gap-2 text-xs text-slate-400">
                ...
                <span>سيتم حفظ بيانات العقد وتوليد رقم فريد تلقائياً إن لم يتم تحديده.</span>
            </div>
